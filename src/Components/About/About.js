...
const About = () => {
  useEffect(()=>{
    ...
    return (
      <div className="bg-blue-200 " id="about">     
           <div className="container mx-auto">
           <h2  data-aos="fade-up"    className="  justify-center text-2xl bg-green-500   px-8 d-inline-block w-48 text-white mx-auto py-3 px-5 mb-8 rounded-full rounded-br-none rounded-tl-none">About me</h2>
              ...
              <div data-aos="fade-right" className="pb-20  align-center px-5">
