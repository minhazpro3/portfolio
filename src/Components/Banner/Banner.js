    ...
    <div className="bg-blue-200 ">
      <div className="grid  sm:grid-cols-1 md:grid-cols-2 gap-2 ">
        <div className="py-32  mx-auto">
          ...
          <h3 data-aos="fade-right" id="kamal" className=" my-2 mb-8 text-purple-600">
            <Typical
          ...
          <div data-aos="fade-up"  >
            <Link className="rounded-full bg-green-400  py-3 px-8 " to="/Resume of Minhaz.pdf" target="_blank" download >Resume <i className="fas fa-download text-white " ></i></Link>
          </div>
        </div>
